...
- **Prompt guard**: blocklist heurística de input (8 call sites), guardrail de
  ...
  embeddings com threshold calibrado (`ANALISE.md` §36) — **off por omissão**:
  apanha violações narrativas com 0 falsos positivos, mas uma verificação
  end-to-end provou que deixa passar um comando destrutivo cru (mede forma, não
  conteúdo).
